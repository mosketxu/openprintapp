        ...
        <div class="py-1 space-y-4">
            ...
            <div class="">
                <div class="flex w-full py-2 pl-2 text-sm text-gray-500 bg-blue-100 rounded-t-md">
                    <div class="w-1/12 pl-2 font-light lg:w-1/12 lg:flex " ><x-label>{{ __('Fila') }}</x-label> </div>
                    <div class="w-3/12 pl-2 font-light lg:w-1/12 lg:flex " ><x-label>{{ __('Cod') }}</x-label></div>
                    <div class="hidden pl-2 font-light lg:w-1/12 lg:flex " ><x-label>{{ __('Store') }}</x-label></div>
                    <div class="w-4/12 pl-2 font-light lg:w-2/12 lg:flex " ><x-label>{{ __('Canal') }}</x-label></div>
                    <div class="w-2/12 pl-2 font-light lg:w-1/12 lg:flex " ><x-label>{{ __('Dirección') }}</x-label></div>
