@if(!$cliente->entidad_id)
    <div class="w-2/12 text-xs">
        ...
        <div class="flex">
            <select wire:model="filtroentidad" class="w-full py-2 text-xs text-gray-600 bg-white border-blue-300 rounded-md shadow-sm appearance-none hover:border-gray-400 focus:outline-none">
