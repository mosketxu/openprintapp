                        ...
                        <thead>
                            <tr style="background-color: #139cdc;">
                                <th style="text-align: right;" width="25%">
                                    ...
                                    <img src="{{public_path('img/logo.png')}}" width="50px">
                                ...
                                <tr>
                                    @foreach($chunk as $elemento)
                                        {{-- <td width="20%" class="celda"> --}}
                                            <td style="
                                                width: 20%; max-width: 20%; word-wrap: break-word; word-break: break-word;
                                            ...
                                            @if($campaign->cabecera->bimagenelemento==true)
                                                <div class="">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <img src="{{public_path('storage/galeria/'.$campaign->id.'/thumbnails/thumb-'.$elemento->campaignElemento->imagenelemento.'?'.time())}}"
