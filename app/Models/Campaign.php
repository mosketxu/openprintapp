...
{
    use HasFactory;
    protected $fillable=['entidad_id','name','fechainicio','fechafin','estado','estadoproceso','numcolumnas','filacod','fichero','fechainstal1','fechainstal2','fechainstal3','montaje1','montaje2','montaje3'];
